...
//[MsgType =36 MsgLen= ]商品期货期权做市询价通知
typedef struct
{
    char						Code[20];				///< 商品代码<2009-1-21 Lumy更改>
	char						ForQuoteSysID[21];		///< 询价编号
} XDFAPI_CNFutOptMkInquiry;

//[MsgType =37 MsgLen= ]中金期货期权做市询价通知
typedef struct
{
    char						Code[20];				///< 商品代码<2009-1-21 Lumy更改>
	char						ForQuoteSysID[21];		///< 询价编号
} XDFAPI_CFFutOptMkInquiry;

//[Msgtype=38 ] 深圳期权做市询价通知
typedef struct
{
     char                       Code[8];		///< 商品代码
     short						InquiryStatus;	///< 做市询价状态
} XDFAPI_SzOptMkInquiry;
